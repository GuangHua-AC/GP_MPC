...
def main() -> None:
    ...
    model = GPDynamicsModel.load(task_output_subdir("terrain", "models") / "terrain_gp.joblib")
    ...
    out = ADAPTIVE_DIR / "mpc" / adaptive_filename("adaptive_gp_mpc", args.terrain_mode, args.v_ref)
    metrics = save_adaptive_result(
        ...
        v_ref=args.v_ref,
        controller=controller_label("adaptive_gp_mpc"),
    ...
    print("task=terrain_adaptive_gp_mpc")
