...
def main() -> None:
    ...
    model = GPDynamicsModel.load(task_output_subdir("balance_turn_roll", "models") / "balance_turn_roll_gp.joblib")
    ref = Reference(
    ...
    mpc = RandomShootingMPC(
        env,
        model,
        MPCConfig(horizon=args.horizon, candidates=args.candidates, uncertainty_weight=args.uncertainty_weight),
    ...
    print("task=balance_turn_roll_gp_mpc")
